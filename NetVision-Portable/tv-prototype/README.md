...
```text
NetVision-iOS-Standalone.html
```

It is a standalone file with the app, styling, database, and subtitle data embedded inside it. If you see a small `Standalone iOS build` badge in the bottom-right corner, you opened the correct file.
